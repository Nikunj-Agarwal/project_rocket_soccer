...
| **[PHYSICS_CONSTRAINTS_ASSUMPTIONS.md](PHYSICS_CONSTRAINTS_ASSUMPTIONS.md)** | Field dimensions, elastic/inelastic collision models, NMPC bounds, target offset equations. |
...
| **[UPDATE.md](UPDATE.md)** | **[NEW]** Overview of the Phase 5 (Strike & Score) overhaul, including key design decisions, fixes, and validation benchmarks. |
